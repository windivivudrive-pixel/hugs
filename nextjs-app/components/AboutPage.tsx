...
export const AboutPage: React.FC = () => {
    ...
    useDocumentHead({
        title: 'Về chúng tôi',
        description: 'Tìm hiểu về HUGs Agency - Agency Marketing tổng thể với đội ngũ 30+ nhân sự, 50+ dự án và 4 năm kinh nghiệm trong ngành.',
        keywords: 'về HUGs Agency, agency marketing, đội ngũ, văn hóa công ty',
    });
