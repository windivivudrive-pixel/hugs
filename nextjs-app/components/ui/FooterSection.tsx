...
const socialLinks = [
    ...
    {
        name: 'WhatsApp',
        url: 'https://wa.me/84778970999', // Assuming same phone number as contact
        icon: (
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-gray-600">
                            ...
                            <li className="flex items-center gap-3">
                                ...
                                <a href="tel:0778970999" className="hover:text-brand-pink transition-colors">0778 970 999</a>
                            </li>
                            <li className="flex items-center gap-3">
