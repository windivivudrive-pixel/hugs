...
import { fetchServices } from '@/lib/actions-client';
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-gray-100 h-20 flex items-center">
                <div className="max-w-7xl mx-auto px-6 w-full flex justify-between items-center">
                    ...
                    <div className="hidden md:flex items-center gap-8 text-sm font-bold uppercase text-gray-700">
                        <Link href="/" className={getLinkClass('home')}>{t('nav.home')}</Link>
                        <Link href="/about" className={getLinkClass('about')}>{t('nav.about')}</Link>
                        ...
                        <Link href="/allprojects" className={getLinkClass('projects')}>{t('nav.projects')}</Link>
                        <Link href="/careers" className={getLinkClass('careers')}>{t('nav.careers')}</Link>
                        <Link href="/news" className={getLinkClass('news')}>{t('nav.news')}</Link>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <LanguageSwitcher />
                        <Link href="/advise" className="hidden md:block bg-brand-dark text-white px-5 py-2 rounded-full text-xs font-bold uppercase hover:bg-brand-pink transition-colors">
                            {t('nav.register')}
                        </Link>
                    </div>
                </div>
