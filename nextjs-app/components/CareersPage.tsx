...
export const CareersPage: React.FC = () => {
    ...
    useDocumentHead({
        title: 'Tuyển dụng',
        description: 'Gia nhập đội ngũ HUGs Agency - Tìm kiếm cơ hội nghề nghiệp trong lĩnh vực marketing, thiết kế, sáng tạo nội dung và nhiều vị trí khác.',
        keywords: 'tuyển dụng, việc làm marketing, careers, HUGs Agency, content creator, designer',
    });
