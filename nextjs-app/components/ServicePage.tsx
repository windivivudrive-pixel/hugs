...
export const ServicePage: React.FC = () => {
    ...
    useDocumentHead({
        ...
        description: 'Khám phá các dịch vụ marketing tổng thể từ HUGs Agency: quản trị fanpage, quảng cáo đa nền tảng, sản xuất video, thiết kế, SEO và tổ chức sự kiện.',
        keywords: 'dịch vụ marketing, quảng cáo, SEO, social media, thiết kế, sản xuất video, HUGs Agency',
    });
    ...
    const handleServiceClick = (slug: string) => {
        router.push(`/projects?service=${slug}`);
    };
